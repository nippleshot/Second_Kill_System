                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid4">
                                ...
                                <div class="product-content">
                                    ...
                                    <a class="add-to-cart" href="/msxt/order.html?userId=${userId}&productId=${product.key.productId}&randomKey=${product.key.randomKey}">立即购买</a>
                                </div>
                            </div>
                        </div>
                    </c:when>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid4">
                                <div class="product-image4">
                                    ...
                                    <span class="product-new-label">已售罄</span>
                                </div>
                                <div class="product-content">
                                    <h3 class="title"><c:out value="${product.key.productName}"/></h3>
                                    <div class="price">
                                    ...
                                    <a class="add-to-cart" href="void(0);" onclick="alert('该产品已售罄');return false;">已售罄</a>
                                </div>
                            </div>
                        </div>
                    </c:when>
