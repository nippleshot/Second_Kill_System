                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid4">
                                ...
                                <div class="product-content">
                                    ...
                                    <a style="color:#ff8400;" href="void(0);" onClick='alert("ÇëµÇÂ¼/×¢²á"); return false'>»î¶¯½áÊø</a>
                                </div>
                            </div>
                        </div>
                    </c:when>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid4">
                                ...
                                <div class="product-content">
                                    ...
                                    <a style="color:#00b35c;" href="void(0);" onClick='alert("ÇëµÇÂ¼/×¢²á"); return false'>»î¶¯Ã»¿ª</a>
                                </div>
                            </div>
                        </div>
                    </c:when>
